...
func genericInt() {
	...
	list1.Add(20)
	list1.Add(30)
	fmt.Println("Initial list:", list1.Items)

	list1.InsertAt(1, 15)
	fmt.Println("After InsertAt(1, 15):", list1.Items)

	list1.RemoveAt(0)
	fmt.Println("After RemoveAt(0):", list1.Items)

	list1.Remove(15)
	fmt.Println("After Remove(15):", list1.Items)
}
